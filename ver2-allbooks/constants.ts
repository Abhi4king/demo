...
export const INITIAL_NODES: FileSystemNode[] = [
  ...
  { id: '5', parentId: '1', name: 'User Manual.pdf', type: NodeType.FILE, fileType: FileType.PDF, size: 850320, uploadDate: new Date('2023-10-23T11:00:00Z'), url: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf' },
